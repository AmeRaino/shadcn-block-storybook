...
type TSelectedState = ReturnType<typeof useSet<string>>;
...
export const MyMultiComboboxTriggerLabel = ({
  children,
  ...props
}: {
...
MyMultiComboboxTriggerLabel.displayName = "MyMultiComboboxTriggerLabel";
